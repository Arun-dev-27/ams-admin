# AMS Admin - demo Business Unit app

A small NestJS app that plays the **AMS Admin** backend (ADMIN realm) and signs in through Miqaat Core
...
npm install
npm run start:dev         # http://localhost:5174
```
...
| Variable | Meaning |
|---|---|
| `APP_KEY`, `APP_LABEL`, `CLIENT_ID`, `APP_REALM` | Which BU app this is (`ams-admin-dev`, realm ADMIN locally) |
